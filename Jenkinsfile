def githubStatusCheck(String state, String description){
    ...
    githubNotify account: 'interacto',sha: "${commitHash}", status: state, description: description, credentialsId: 'github-token', repo: 'example-jfx-drawingeditor'
}
    ...
    stages {
        ...
        stage ('Git') {
            steps {
                ...
                git branch: 'master', url: "https://github.com/interacto/example-jfx-drawingeditor"
            }
        }
