...
import io.interacto.ex.draw.command.AddShape;
import io.interacto.ex.draw.command.ChangeColour;
import io.interacto.ex.draw.command.MoveShape;
import io.interacto.ex.draw.command.Save;
import io.interacto.ex.draw.learning.AddRectHelpAnimation;
import io.interacto.ex.draw.learning.MoveRectHelpAnimation;
import io.interacto.ex.draw.model.MyDrawing;
import io.interacto.ex.draw.model.MyRect;
import io.interacto.ex.draw.model.MyShape;
import io.interacto.ex.draw.view.MyCanvas;
import io.interacto.ex.draw.view.ViewFactory;
import io.interacto.ex.util.ColorCursor;
import io.interacto.jfx.instrument.JfxInstrument;
import io.interacto.jfx.interaction.library.DnD;
import io.interacto.jfx.interaction.library.Press;
import io.interacto.logging.LogLevel;
import java.net.URL;
